 ...
 *
 * The falsy list is wide on purpose: callers write `error && "..."` where
 * `error` is a ReactNode, which can be null, 0 or an empty string, and a
 * narrower signature rejected those at the call site rather than here. */
const cx = (...parts: Array<string | number | bigint | boolean | null | undefined>) =>
