...
function DesktopTopbar({ view, selectedKey, go }: { view: View; selectedKey: KeyName; go: (view: View) => void }) {
  const labels: Record<View,string> = { today:"Today",drills:"Drill library",train:"Recall trainer",keys:"Key explorer",progress:"Your progress",routines:"Routines",runner:"Session runner",summary:"Session summary",grouped:"Grouped drills","drill-detail":"Drill detail","key-detail":"Key detail","scale-detail":"Scale study","routine-detail":"Routine detail",guided:"Guided routine" };
